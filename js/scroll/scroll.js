  // Ordena aleatoriamente el array de imágenes
  images.sort(() => Math.random() - 0.5);

  // Recorre el array de imágenes y agrega cada una al contenedor de imágenes
  ...
  images.forEach(image => {
    ...
    user.setAttribute("href","https://www.google.com/");
    const user_profile = document.createElement('img');
    user_profile.setAttribute("src", image.profile );
